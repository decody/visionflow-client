...
export function FaqPage({ faqs, category = 'default', description = '미팅 전에 미리 답변해 드립니다. 더 궁금한 점은 카카오톡 채널로 바로 문의 가능합니다.', headerSlot, helpSlot, }) {
    const filteredFaqs = sortFaqs(faqs.filter((faq) => faq.category?.trim() === category));
