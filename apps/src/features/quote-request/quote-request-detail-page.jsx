...
import { ArrowLeft, ArrowRight, ChevronDown, ChevronUp, Eye, FileText, Globe, MapPin, MoreHorizontal, Paperclip, Plus, Send, Timer, } from 'lucide-react';
import Link from 'next/link';
import { useState } from 'react';
import styles from './quote-request-detail-page.module.css';
const TABS = [
    { count: null, key: 'request', label: '요청 본문' },
    { count: null, key: 'quote', label: '견적서 작성' },
    { count: null, key: 'reply', label: '회신' },
    { count: 8, key: 'history', label: '히스토리' },
...
export function QuoteRequestDetailPage({ id }) {
        ...
        <article className={styles.quoteBuilder}>
          ...
          <div className={styles.itemTableWrap}>
            <table className={styles.itemTable}>
              ...
              <tbody>
                {LINE_ITEMS.map((item) => (<tr key={item.id}>
                    <td>
