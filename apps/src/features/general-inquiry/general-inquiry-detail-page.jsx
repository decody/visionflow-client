...
import { ArrowLeft, Bold, Check, ChevronDown, ChevronUp, FileText, Heading1, Heading2, Italic, Link2, List, Mail, MoreHorizontal, Paperclip, Send, Timer, Underline, } from 'lucide-react';
...
export function GeneralInquiryDetailPage({ id }) {
