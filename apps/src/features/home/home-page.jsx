...
export function HomePage() {
    ...
    return (<>
      <section className={styles.hero}>
        ...
        {heroChips.map((c) => (<span aria-hidden="true" className={styles.heroFloatChip} key={c.label} style={{
                top: `${c.top}px`,
                left: `${c.left}px`,
      ...
      <section className={styles.services}>
        <Container>
          ...
          <ul className={styles.servicesGrid}>
            {services.map((s) => (<li className={styles.serviceItem} key={s.title}>
                <Link className={styles.serviceCard} href={s.href}>
                  ...
                  <div className={styles.serviceBody}>
                    ...
                    <div className={styles.serviceTags}>
                      {s.tags.map((t) => (<span className={styles.serviceTag} key={t}>
                          {t}
                        </span>))}
                    </div>
                  </div>
      ...
      <section className={styles.why}>
        <Container>
          ...
          <ul className={styles.whyGrid}>
            {whyCards.map((w) => (<li className={styles.whyItem} key={w.no}>
      ...
      <section className={styles.featured}>
        <Container>
          ...
          <ul className={styles.featuredGrid}>
            {featuredWorks.map((w) => (<li className={styles.featuredItem} key={w.title}>
      ...
      <section className={styles.stats}>
        <Container>
          ...
          <div className={styles.statsRow}>
            {stats.map((s, i) => (<div className={styles.statItem} key={s.label}>
                ...
                {i < stats.length - 1 ? (<span aria-hidden="true" className={styles.statSep}/>) : null}
              </div>))}
          </div>
        </Container>
      </section>
      ...
      <section className={styles.process}>
        <Container>
          ...
          <ol className={styles.processList}>
            {processSteps.map((s, i) => (<li className={styles.processItem} key={s.no}>
                ...
                {i < processSteps.length - 1 ? (<span aria-hidden="true" className={styles.processConnector}/>) : null}
              </li>))}
          </ol>
        </Container>
      </section>
      ...
      <section className={styles.logos}>
        <Container>
          ...
          {customerLogos.map((row, i) => (<ul className={styles.logoRow} key={`row-${i}`}>
              {row.map((logo) => (<li className={styles.logoItem} key={logo}>
                  {logo}
                </li>))}
            </ul>))}
        </Container>
      ...
      <section className={styles.testimonials}>
        <Container>
          ...
          <ul className={styles.tGrid}>
            {testimonials.map((t) => (<li className={styles.tItem} key={t.author}>
                <article className={styles.tCard}>
                  ...
                  <div className={styles.tAuthor}>
                    <span aria-hidden="true" className={styles.tAvatar} style={{ background: t.avatarColor }}>
                      {t.initial}
                    </span>
