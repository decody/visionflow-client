      ...
      <section className={styles.types}>
        <Container>
          ...
          <ul className={styles.typeGrid}>
            {types.map((t) => (<li className={styles.typeItem} key={t.title}>
        ...
        <Container>
          ...
          <form className={styles.formCard}>
            ...
            <div className={styles.formField}>
              ...
              <input className={styles.formInput} id="pf-company" name="company" placeholder="예) VisionFlow 주식회사" required type="text"/>
            </div>
            <fieldset className={styles.formField}>
              ...
              <div className={styles.chipGroup}>
                {companySizeOptions.map((o) => (<button className={`${styles.chip} ${o.active ? styles.chipActive : ''}`} key={o.label} type="button">
                    {o.label}
                  </button>))}
              </div>
            </fieldset>
            ...
            <div className={styles.formRow}>
              <div className={styles.formField}>
                ...
                <input className={styles.formInput} id="pf-name" name="name" placeholder="담당자 이름" required type="text"/>
              </div>
              <div className={styles.formField}>
                <label className={styles.formLabel} htmlFor="pf-role">
                  직책 <span className={styles.formRequired}>*</span>
                </label>
                <input className={styles.formInput} id="pf-role" name="role" placeholder="예) 사업개발 매니저" required type="text"/>
              </div>
            </div>
            <div className={styles.formRow}>
              <div className={styles.formField}>
                ...
                <input className={styles.formInput} id="pf-email" name="email" placeholder="contact@yourcompany.com" required type="email"/>
              </div>
              <div className={styles.formField}>
                <label className={styles.formLabel} htmlFor="pf-phone">
                  연락처 <span className={styles.formOptional}>(선택)</span>
                </label>
                <input className={styles.formInput} id="pf-phone" name="phone" placeholder="010-0000-0000" type="tel"/>
              </div>
            </div>
            ...
            <fieldset className={styles.formField}>
              ...
              <div className={styles.chipGroup}>
                {partnershipTypeOptions.map((label) => (<button className={styles.chip} key={label} type="button">
                    {label}
                  </button>))}
              </div>
            </fieldset>
            ...
            <div className={styles.formField}>
              ...
              <textarea className={styles.formTextarea} id="pf-message" name="message" placeholder={'귀사의 사업 영역과 어떤 형태의 협력을 제안하시는지 구체적으로 작성해주세요.\n예) 보유 고객·시장·기술·콘텐츠와 우리의 어떤 서비스를 결합할 때 어떤 가치가 만들어지는지.'} required/>
            ...
            <div className={styles.formField}>
              ...
              <input className={styles.formInput} id="pf-url" name="url" placeholder="https://yourcompany.com 또는 IR 자료 링크" type="url"/>
            </div>
            ...
            <div className={styles.formField}>
              ...
              <label className={styles.dropZone} htmlFor="pf-files">
                ...
                <input accept=".pdf,.zip,image/*" className={styles.dropZoneInput} id="pf-files" multiple name="files" type="file"/>
              </label>
            </div>
            ...
            <div className={styles.consentRow}>
              <label className={styles.consent} htmlFor="pf-consent">
                <input className={styles.consentInput} defaultChecked id="pf-consent" name="consent" required type="checkbox"/>
      ...
      <section className={styles.process}>
        <Container>
          ...
          <ol className={styles.processGrid}>
            {processSteps.map((s) => (<li className={styles.processItem} key={s.no}>
        ...
        <Container>
          <div className={styles.ctaInner}>
            ...
            <div className={styles.ctaActions}>
              <Link className={`${styles.ctaButton} ${styles.ctaButtonOnPrimary}`} href={`${ROUTES.CONTACT}#quote`}>
                견적 문의 →
              </Link>
              <Link className={`${styles.ctaButton} ${styles.ctaButtonGhost}`} href={`${ROUTES.CONTACT}/general`}>
                일반 문의 →
              </Link>
            </div>
          </div>
