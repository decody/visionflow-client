      ...
      <section className={styles.brand} aria-hidden="true">
        ...
        <div className={styles.brandHero}>
          ...
          <p className={styles.brandLead}>
            견적·제휴·일반·Q&A 4채널 인박스, Work 케이스 발행, SLA 모니터링, 감사 로그까지 —
            VisionFlow가 직접 만들어 운영하는 어드민 콘솔.
          </p>
        </div>

        <ul className={styles.statGrid}>
          {STAT_CARDS.map((stat) => (<li className={styles.statCard} key={stat.label}>
      ...
      <main className={styles.formArea}>
        ...
        <form className={styles.form} onSubmit={(event) => {
          ...
          <header className={styles.formHeader}>
            ...
            <p className={styles.formSubtitle}>VisionFlow 운영자만 접근 가능한 페이지입니다.</p>
          </header>
          ...
          <section className={styles.ssoBlock}>
            ...
            <button className={styles.ssoButton} onClick={() => void signIn('google', { callbackUrl: '/' })} type="button">
              <GoogleIcon />
              <span>Google Workspace로 계속하기</span>
            </button>
            <button className={styles.ssoButton} onClick={() => void signIn('naver', { callbackUrl: '/' })} type="button">
              <NaverIcon />
              <span>네이버로 계속하기</span>
            </button>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.inputWrap}>
              ...
              <input autoComplete="email" className={styles.input} id="login-email" name="email" placeholder="name@example.com" type="email"/>
            </div>
          </div>
          ...
          <div className={styles.field}>
            ...
            <div className={styles.inputWrap}>
              ...
              <input autoComplete="current-password" className={styles.input} id="login-password" name="password" placeholder="••••••••••••" type={showPassword ? 'text' : 'password'}/>
          ...
          <div className={styles.toggleRow}>
            <label className={styles.checkbox}>
              <input className={styles.checkboxInput} name="remember" type="checkbox"/>
          ...
          <aside className={styles.policy}>
            ...
            <div>
              ...
              <p className={styles.policyBody}>
                SuperAdmin·Sales 역할은 TOTP 2단계 인증이 필수입니다. 8시간 비활동 시 자동 로그아웃 ·
                모든 로그인 시도는 감사 로그에 기록됩니다.
              </p>
            </div>
          </aside>
