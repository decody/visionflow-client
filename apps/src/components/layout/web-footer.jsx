      ...
      <div className={styles.inner}>
        <div className={styles.top}>
          ...
          <nav aria-label="Footer service navigation" className={styles.linkGroup}>
            ...
            {serviceLinks.map((item) => (<Link className={styles.footerLink} href={item.href} key={item.href}>
                {item.label}
              </Link>))}
          </nav>
          ...
          <nav aria-label="Footer company navigation" className={styles.linkGroup}>
            ...
            {companyLinks.map((item) => (<Link className={styles.footerLink} href={item.href} key={item.href}>
                {item.label}
              </Link>))}
          </nav>
        </div>
